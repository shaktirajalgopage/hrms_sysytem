                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="tel" name="emergency_phone" class="form-control"
                                            id="emergency_phone" value="{{ $employee->emergency_phone }}" maxlength="19" />
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="blood_group" class="form-control" id="blood_group">
                                            ...
                                            @foreach (['A+ve', 'A-ve', 'B+ve', 'B-ve', 'AB+ve', 'AB-ve', 'O+ve', 'O-ve'] as $bg)
                                                <option value="{{ $bg }}"
                                                    {{ $employee->blood_group === $bg ? 'selected' : '' }}>
                                                    {{ $bg }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select name="religion" class="form-control" id="religion">
                                            <option value="">{{ __('-- Choose One --') }}</option>
                                            <option value="1" {{ $employee->religion === 1 ? 'selected' : '' }}>
                                                {{ __('Islam') }}</option>
                                            <option value="2" {{ $employee->religion === 2 ? 'selected' : '' }}>
                                                {{ __('Christian') }}</option>
                                            <option value="3" {{ $employee->religion === 3 ? 'selected' : '' }}>
                                                {{ __('Hinduism') }}</option>
                                            <option value="4" {{ $employee->religion === 4 ? 'selected' : '' }}>
                                                {{ __('Buddhist') }}</option>
                                            <option value="5" {{ $employee->religion === 5 ? 'selected' : '' }}>
                                                {{ __('Others') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-4">
                                        ...
                                        <select name="marital" class="form-control" id="marital">
                                            <option value="">{{ __('-- Choose One --') }}</option>
                                            <option value="1" {{ $employee->marital === 1 ? 'selected' : '' }}>
                                                {{ __('Married') }}</option>
                                            <option value="2" {{ $employee->marital === 2 ? 'selected' : '' }}>
                                                {{ __('Unmarried') }}</option>
                                            <option value="3" {{ $employee->marital === 3 ? 'selected' : '' }}>
                                                {{ __('Divorced') }}</option>
                                            <option value="4" {{ $employee->marital === 4 ? 'selected' : '' }}>
                                                {{ __('Widowed') }}</option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <select name="status" class="form-control" id="status">
                                            ...
                                            @foreach ([1 => 'Currently Employed', 2 => 'Retired', 3 => 'Resigned', 4 => 'Terminated', 5 => 'On Leave', 6 => 'Contract Ended', 7 => 'Part-Time', 8 => 'Full-Time', 9 => 'Freelancer', 10 => 'Intern', 11 => 'Transferred'] as $val => $label)
                                                <option value="{{ $val }}"
                                                    {{ $employee->status === $val ? 'selected' : '' }}>{{ __($label) }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-6">
                                        ...
                                        <input type="number" name="provident_fund" class="form-control"
                                            id="providentFund" value="{{ $employee->salary?->provident_fund }}"
                                            step="0.01" readonly />
                                    </div>
                                    <div class="col-6">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="number" name="health_insurance" class="form-control"
                                            id="healthInsurance" value="{{ $employee->salary?->health_insurance }}"
                                            step="0.01" readonly />
                                    </div>
                                    <div class="col-6">
                                        <label>{{ __('Life Insurance') }}</label>
                                        <input type="number" name="life_insurance" class="form-control"
                                            id="lifeInsurance" value="{{ $employee->salary?->life_insurance }}"
                                            step="0.01" readonly />
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <label for="imageInput"
                                            ...
                                            <div class="d-flex flex-column align-items-center justify-content-center py-1">
                                                ...
                                                <h6 class="my-1 text-dark text-center">
                                                    <strong>{{ __('Click to upload') }}</strong></h6>
